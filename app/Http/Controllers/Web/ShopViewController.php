...
class ShopViewController extends Controller
{
    public function getShopInfoArray($shopId, $shopProducts, $sellerType, $sellerId): array
    {
        ...
        return [
            ...
            'temporary_close' => $shopId == 0 ? checkVendorAbility(type: 'inhouse', status: 'temporary_close') : checkVendorAbility(type: 'vendor', status: 'temporary_close', vendor: $shop),
            'vacation_status' => $shopId == 0 ? checkVendorAbility(type: 'inhouse', status: 'vacation_status') : checkVendorAbility(type: 'vendor', status: 'vacation_status', vendor: $shop),
    ...
    public function seller_shop(Request $request, $id): View|JsonResponse|Redirector|RedirectResponse
    {
        ...
        if (getWebConfig(name: 'business_mode') == 'single' && $id != 0) {
    ...
    public function getShopCategoriesList($products)
    {
        ...
        $categoryIds = [];
        if (is_array($categoryInfoDecoded)) {
